...
int main()//driver function//
{
  ...
  while(1)
  {
	...
	switch(choice)
	{
  	case 1: begin_insert();//calling function//
          		break;
  	case 2: last_insert();//calling function//
          		break;
  	case 3: random_insert();//calling function//
          		break;
  	case 4: begin_delete();//calling function//
          		break;
  	case 5: last_delete();//calling function//
          		break;
  	case 6: delete_random();//calling function//
          		break;
  	case 7: display();//calling function//
          		break;   
